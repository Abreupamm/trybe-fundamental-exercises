...
function dados (dadosPessoais, dadosProfissionais){
const todosDados = ({...dadosPessoais, ...dadosProfissionais})
return todosDados
}

console.log(dados(user, jobInfos));
...
const {name, age, nationality, profession, squadInitials, squad} = dados(user, jobInfos)
